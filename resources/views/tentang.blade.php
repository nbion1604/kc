...
<section class="section about-page">
	<div class="container">
		<div class="row">
			<div class="col-lg-4">
				<h2 class="title-color">Sistem Pakar Diagnosa Penyakit Gigi & Mulut </h2>
			</div>
			<div class="col-lg-8">
				<p>Sistem pakar diagnosa penyakit Gigi & Mulut merupakan sistem yang dibangun dan dikembangkan dengan tujuan untuk memudahkan
                    pasien melakukan konsutasi keluhan yang dimiliki pasien, sistem ini sudah mendapat izin dan dukungan dari beberpa pakar sesuai bidang masing-masing
...
<section class="section awards">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-4">
				<h2 class="title-color">Dukungan </h2>
		...
		<div class="row justify-content-center">
			<div class="col-lg-6">
				<div class="section-title text-center">
					<h2 class="mb-4">Pakar Spesialis</h2>
