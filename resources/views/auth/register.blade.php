                  ...
                  <div class="form-group d-flex justify-content-center">
                    <div class="form-check form-check-flat mt-0">
                      <label class="form-check-label">
                        <input type="checkbox" name="level" value="pasien" checked id="level"  class="form-check-input" checked>Saya sebagai pasen</label>
                    </div>
                  </div>
                  <div class="form-group">
                    <button type="submit" id="signup" class="btn btn-primary submit-btn btn-block" value="Daftar"/ >Register</button>
                  </div>
